...
export function isTeamOrgSimpleLayout(layoutId) {
...
export function teamOrgSimpleGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutTeamOrgSimple(elements, schema, palette = {}, canvas = {}) {
