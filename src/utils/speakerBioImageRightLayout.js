...
export function isSpeakerBioImageRightLayout(layoutId, schema) {
...
export const SPEAKER_BIO_IMAGE_RIGHT_DEFAULTS = {
...
export function buildSpeakerBioImageRightChromeSvg() {
...
export function layoutSpeakerBioImageRight(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildSpeakerBioImageRightCanvasElements({ schema, options = {} } = {}) {
...
export function speakerBioImageRightPreviewSvg() {
