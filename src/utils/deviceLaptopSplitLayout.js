/** Left copy + laptop mockup inset so chrome is not clipped at the slide edge. */

export function isDeviceLaptopSplitLayout(layoutId) {
...
export function layoutDeviceLaptopSplit(elements, schema, palette = {}, canvas = {}) {
