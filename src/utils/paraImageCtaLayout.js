...
export function isParaImageCtaLayout(layoutId, schema) {
...
export const PARA_IMAGE_CTA_DEFAULTS = {
...
export function buildParaImageCtaChromeSvg() {
...
export function buildParaImageCtaPillSvg() {
...
export function layoutParaImageCta(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildParaImageCtaCanvasElements({ schema, options = {} } = {}) {
...
export function paraImageCtaPreviewSvg() {
