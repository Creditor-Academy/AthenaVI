...
export function isTeamSpeakerBioLayout(layoutId, schema) {
...
export const TEAM_SPEAKER_BIO_DEFAULTS = {
...
export function buildTeamSpeakerBioChromeSvg() {
...
export function layoutTeamSpeakerBio(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildTeamSpeakerBioCanvasElements({ schema, options = {} } = {}) {
...
export function teamSpeakerBioPreviewSvg() {
