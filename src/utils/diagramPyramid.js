...
export function pyramidStageGeom(i) {
...
export function pyramidStageViewBox(i) {
  const g = pyramidStageGeom(i)
  const pad = g.tabR + 8
...
export function pyramidStagePlacement(gx, gy, gw, gh, i) {
...
export function pyramidStageInlineSvg(i) {
  const v = pyramidStageViewBox(i)
...
export function pyramidGraphicBox(canvasW, canvasH) {
  const headingY = 36
  const headingH = 70
...
export function pyramidLegendPlacements(frame) {
...
export function pyramidDiagramInlineSvg(colors = PYRAMID_COLORS) {
