...
export function isContactLeftImageLayout(layoutId, schema) {
...
export const CONTACT_LEFT_IMAGE_DEFAULTS = {
  HEADING: 'Contact me',
...
export function buildContactLeftImageChromeSvg() {
  const {
...
export function layoutContactLeftImage(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildContactLeftImageCanvasElements({ schema, options = {} } = {}) {
...
export function contactLeftImagePreviewSvg() {
