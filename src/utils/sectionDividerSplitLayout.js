...
export const SECTION_DIVIDER_SPLIT_GEOM = {
  viewW: 1000,
  viewH: 560,
  headingX: 56,
  headingY: 188,
...
export const SECTION_DIVIDER_SPLIT_ACCENT = '#148A80'

export const SECTION_DIVIDER_SPLIT_DEFAULTS = {
...
export function isSectionDividerSplitLayout(layoutId) {
...
export function buildSplitChromeSvg() {
  const width = 1000
  const height = 560
...
export function layoutSectionDividerSplit(docOrElements, schema, palette = {}, canvas = {}) {
...
export function sectionDividerSplitPreviewSvg() {
  const g = SECTION_DIVIDER_SPLIT_GEOM
