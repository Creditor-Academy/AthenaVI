...
export function isClosingContactCtaLayout(layoutId, schema) {
...
export const CLOSING_CONTACT_CTA_DEFAULTS = {
...
export function buildClosingContactCtaChromeSvg() {
...
export function buildClosingContactCtaPillSvg() {
...
export function layoutClosingContactCta(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildClosingContactCtaCanvasElements({ schema, options = {} } = {}) {
...
export function closingContactCtaPreviewSvg() {
