...
export function isTeamSixLayout(layoutId) {
...
export function teamSixGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutTeamSix(elements, schema, palette = {}, canvas = {}) {
