...
export const AGENDA_NUMBERED_BLOCKS_GEOM = {
  viewW: 1000,
  viewH: 560,
  headingY: 18,
  headingH: 44,
...
export const NUMBERED_BLOCK_PALETTE = [
...
export function agendaNumberedBlocksGraphicFrame(canvasW, canvasH) {
  return {
    graphicX: 0,
    graphicY: 0,
    graphicW: canvasW,
...
export function agendaNumberedBlockInlineSvg(spec) {
  const w = spec.w
  const h = spec.h
...
export function agendaNumberedBlocksChromeSpecs() {
...
export function agendaNumberedBlocksOverlayPlacements(gx, gy, gw, gh) {
...
export function agendaNumberedBlocksPreviewSvg() {
...
export function specToNumberedBlocksContent(spec) {
  return { svg: agendaNumberedBlockInlineSvg(spec), colorMode: 'original', fill: spec.color }
}

export function isAgendaNumberedBlocksLayout(layoutId, family, variant) {
...
export function isAgendaNumberedBlocksTextSlot(slotId) {
