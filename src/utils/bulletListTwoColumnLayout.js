...
export const BULLET_LIST_TWO_COLUMN_GEOM = {
  viewW: 1000,
  viewH: 560,
  headingX: 56,
  headingY: 28,
...
export const BULLET_LIST_TWO_COLUMN_ACCENT = '#148A80'

export const BULLET_LIST_TWO_COLUMN_DEFAULTS = {
...
export function isBulletListTwoColumnLayout(layoutId) {
...
export function buildTwoColumnPanelSvg({ width, height, iconR, panelH, accentDots = true, includeCopy = false, left = [], right = [] }) {
...
export function layoutBulletListTwoColumn(docOrElements, schema, palette = {}, canvas = {}) {
...
export function bulletListTwoColumnPreviewSvg() {
  const g = BULLET_LIST_TWO_COLUMN_GEOM
  const chromeY = g.panelY - g.iconR
  const chromeH = g.panelH + g.iconR
