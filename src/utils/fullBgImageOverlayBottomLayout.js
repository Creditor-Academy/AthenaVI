...
export function isFullBgImageOverlayBottomLayout(layoutId, schema) {
...
export const FULL_BG_IMAGE_OVERLAY_BOTTOM_DEFAULTS = {
...
export function buildFullBgImageOverlayBottomChromeSvg() {
...
export function layoutFullBgImageOverlayBottom(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildFullBgImageOverlayBottomCanvasElements({ schema, options = {} } = {}) {
...
export function fullBgImageOverlayBottomPreviewSvg() {
  const chrome = buildFullBgImageOverlayBottomChromeSvg()
    .replace(/currentColor/g, '#6366F1')
    .replace(/^<svg[^>]*>/, '')
    .replace(/<\/svg>\s*$/, '')
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080" width="100%" height="100%">
    <defs>
      <linearGradient id="fbiobSky" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stop-color="#7EC8E8" />
        <stop offset="55%" stop-color="#B7D4E8" />
        <stop offset="100%" stop-color="#D0E3EF" />
      </linearGradient>
      <linearGradient id="fbiobHill" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stop-color="#8FBF8E" />
        <stop offset="100%" stop-color="#5E945D" />
      </linearGradient>
    </defs>
    <rect width="1920" height="1080" fill="url(#fbiobSky)" />
    <ellipse cx="420" cy="180" rx="140" ry="52" fill="#FFFFFF" opacity="0.92" />
    <ellipse cx="540" cy="180" rx="90" ry="40" fill="#FFFFFF" opacity="0.92" />
    <path d="M0 520 C360 400 720 580 1080 440 C1320 360 1560 500 1920 400 L1920 1080 L0 1080 Z" fill="url(#fbiobHill)" />
    ${chrome}
    <text x="960" y="700" text-anchor="middle" fill="#FFFFFF" font-size="56" font-weight="800" font-family="system-ui, sans-serif">Presentation title</text>
    <text x="960" y="820" text-anchor="middle" fill="rgba(255,255,255,0.88)" font-size="28" font-weight="600" font-family="system-ui, sans-serif">Supporting line or tagline</text>
    <text x="960" y="890" text-anchor="middle" fill="rgba(255,255,255,0.78)" font-size="24" font-family="system-ui, sans-serif">Copy sits on a quiet band at the bottom of the photo.</text>
  </svg>`
}
