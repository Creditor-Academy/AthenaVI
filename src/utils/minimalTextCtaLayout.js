...
export function isMinimalTextCtaLayout(layoutId, schema) {
...
export const MINIMAL_TEXT_CTA_DEFAULTS = {
  HEADING: 'Thank you',
  CTA: 'Book a demo',
}
...
export function buildMinimalTextCtaChromeSvg() {
  const { ruleY } = GEOM
...
export function buildMinimalTextCtaPillSvg() {
...
export function layoutMinimalTextCta(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildMinimalTextCtaCanvasElements({ schema, options = {} } = {}) {
...
export function minimalTextCtaPreviewSvg() {
