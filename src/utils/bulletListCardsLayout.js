...
export function isBulletListCardsLayout(layoutId) {
  return /bullet_list_(cards|grid)/i.test(String(layoutId || ''))
}

export function bulletListCardsGeom(canvasW = 1920, canvasH = 1080, isGrid = false) {
...
export function layoutBulletListCards(elements, schema, palette = {}, canvas = {}) {
