export const MATRIX_QUAD_COLORS = ['#5B8FC4', '#5B8FC4', '#4A7EB0', '#4A7EB0']
export const MATRIX_ARROW_COLOR = '#6B9FD4'

export const MATRIX_GEOM = {
  viewW: 1400,
  viewH: 980,
  arrowW: 72,
  arrowGap: 32,
...
export function matrixGridRect() {
...
export function matrixCellRect(index) {
...
export function matrixOverlayPlacements(gx, gy, gw, gh) {
...
export function matrixQuadPlacement(gx, gy, gw, gh, index) {
  const sx = gw / MATRIX_GEOM.viewW
  const sy = gh / MATRIX_GEOM.viewH
...
export function matrixArrowPlacement(gx, gy, gw, gh, axis) {
  const sx = gw / MATRIX_GEOM.viewW
  const sy = gh / MATRIX_GEOM.viewH
...
export function matrixArrowInlineSvg(axis) {
  const { arrowW, arrowGap, head } = MATRIX_GEOM
  const { gridX, gridY, gridW, gridH } = matrixGridRect()
  if (axis === 'y') {
...
export function buildMatrixDiagramSvg(colors = MATRIX_QUAD_COLORS) {
...
export function matrixDiagramInlineSvg(colors = MATRIX_QUAD_COLORS) {
...
export const MATRIX_GRID_COLORS = ['#1e3a5f', '#2563eb', '#0f766e', '#475569']

export const MATRIX_Q_TINTS = ['#E8EEF7', '#FFF1E6', '#E7F6F2', '#F1F5F9']
export const MATRIX_Q_TITLE = ['#1e3a5f', '#c2410c', '#0f766e', '#334155']
export const MATRIX_Q_AXIS = '#1e293b'

export function matrixGridPreviewSvg() {
...
export function matrixQuadrantCrossInlineSvg() {
...
export function matrixQuadrantPreviewSvg() {
