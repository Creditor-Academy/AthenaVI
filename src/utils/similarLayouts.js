...
export const LAYOUT_SIMILAR_OVERRIDES = {
  ...
  agenda_numbered_v1: ['agenda_numbered_timeline_v1'],
  agenda_numbered_timeline_v1: ['agenda_numbered_v1'],
  agenda_three_columns_hero_v1: ['agenda_three_cards_hero_v1'],
  agenda_three_cards_hero_v1: ['agenda_three_columns_hero_v1'],
  agenda_three_columns_v1: ['agenda_three_cards_v1'],
  agenda_three_cards_v1: ['agenda_three_columns_v1'],
  agenda_timeline_preview_v1: ['agenda_vertical_roadmap_v1'],
  agenda_vertical_roadmap_v1: ['agenda_timeline_preview_v1'],
  agenda_two_column_v1: ['agenda_split_panel_v1'],
  agenda_split_panel_v1: ['agenda_two_column_v1'],
  pricing_comparison_table_v1: ['pricing_comparison_cards_v1'],
  pricing_comparison_cards_v1: ['pricing_comparison_table_v1'],
  pricing_four_para_v1: ['pricing_four_para_cards_v1'],
  pricing_four_para_cards_v1: ['pricing_four_para_v1'],
  pricing_four_plans_v1: ['pricing_four_plans_featured_v1'],
  pricing_four_plans_featured_v1: ['pricing_four_plans_v1'],
  pricing_three_highlight_v1: ['pricing_three_highlight_split_v1'],
  pricing_three_highlight_split_v1: ['pricing_three_highlight_v1'],
  pricing_three_plans_v1: ['pricing_three_plans_featured_v1'],
  pricing_three_plans_featured_v1: ['pricing_three_plans_v1'],
  timeline_horizontal_v1: ['timeline_horizontal_cards_v1'],
  timeline_horizontal_cards_v1: ['timeline_horizontal_v1'],
  timeline_milestones_image_v1: ['timeline_milestones_image_right_v1'],
  timeline_milestones_image_right_v1: ['timeline_milestones_image_v1'],
  timeline_milestones_v1: ['timeline_milestones_cards_v1'],
  timeline_milestones_cards_v1: ['timeline_milestones_v1'],
  timeline_roadmap_v1: ['timeline_roadmap_horizontal_v1'],
  timeline_roadmap_horizontal_v1: ['timeline_roadmap_v1'],
  timeline_process_steps_v1: ['timeline_process_horizontal_v1'],
  timeline_process_horizontal_v1: ['timeline_process_steps_v1'],
  timeline_vertical_v1: ['timeline_vertical_cards_v1'],
  timeline_vertical_cards_v1: ['timeline_vertical_v1'],
  chart_donut_context_v1: ['chart_donut_context_right_v1'],
  chart_donut_context_right_v1: ['chart_donut_context_v1'],
  chart_exponential_desc_v1: ['chart_exponential_desc_side_v1'],
  chart_exponential_desc_side_v1: ['chart_exponential_desc_v1'],
  chart_with_description_v1: ['chart_with_description_side_v1'],
  chart_with_description_side_v1: ['chart_with_description_v1'],
  chart_single_v1: ['chart_single_split_v1'],
  chart_single_split_v1: ['chart_single_v1'],
  chart_three_context_v1: ['chart_three_context_cards_v1'],
  chart_three_context_cards_v1: ['chart_three_context_v1'],
  chart_three_donut_v1: ['chart_three_donut_cards_v1'],
  chart_three_donut_cards_v1: ['chart_three_donut_v1'],
  chart_three_v1: ['chart_three_cards_v1'],
  chart_three_cards_v1: ['chart_three_v1'],
  chart_two_cards_v1: ['chart_two_cards_split_v1'],
  chart_two_cards_split_v1: ['chart_two_cards_v1'],
  chart_two_v1: ['chart_two_split_v1'],
  chart_two_split_v1: ['chart_two_v1'],
  metric_five_v1: ['metric_five_cards_v1'],
  metric_five_cards_v1: ['metric_five_v1'],
  metric_four_v1: ['metric_four_cards_v1'],
  metric_four_cards_v1: ['metric_four_v1'],
  metric_three_v1: ['metric_three_cards_v1'],
  metric_three_cards_v1: ['metric_three_v1'],
  metric_single_v1: ['metric_single_split_v1'],
  metric_single_split_v1: ['metric_single_v1'],
  metric_six_para_v1: ['metric_six_cards_v1'],
  metric_six_cards_v1: ['metric_six_para_v1'],
  metric_three_vertical_v1: ['metric_three_vertical_cards_v1'],
  metric_three_vertical_cards_v1: ['metric_three_vertical_v1'],
  metric_two_v1: ['metric_two_split_v1'],
  metric_two_split_v1: ['metric_two_v1'],
  process_linner_horti_four_v1: ['process_linear_four_cards_v1'],
  process_linear_four_cards_v1: ['process_linner_horti_four_v1'],
  process_linner_horti_v1: ['process_linear_horizontal_v2'],
  process_linear_horizontal_v2: ['process_linner_horti_v1'],
  process_linner_numeric_v1: ['process_linear_numeric_cards_v1'],
  process_linear_numeric_cards_v1: ['process_linner_numeric_v1'],
  table_single_v1: ['table_single_cards_v1'],
  table_single_cards_v1: ['table_single_v1'],
  table_two_desc_v1: ['table_two_desc_cards_v1'],
  table_two_desc_cards_v1: ['table_two_desc_v1'],
  table_two_same_header_v1: ['table_two_same_header_cards_v1'],
  table_two_same_header_cards_v1: ['table_two_same_header_v1'],
  table_with_description_v1: ['table_with_description_side_v1'],
  table_with_description_side_v1: ['table_with_description_v1'],
  eight_short_texts_image_v1: ['eight_short_texts_image_right_v1'],
  eight_short_texts_image_right_v1: ['eight_short_texts_image_v1'],
  grid_bento_four_v1: ['grid_four_mosaic_v1'],
  grid_four_mosaic_v1: ['grid_bento_four_v1'],
  grid_bento_three_v1: ['grid_three_asymmetric_v1'],
  grid_three_asymmetric_v1: ['grid_bento_three_v1'],
  grid_device_mockups_v1: ['grid_device_mockups_feature_v1'],
  grid_device_mockups_feature_v1: ['grid_device_mockups_v1'],
  grid_images_text_cards_v1: ['grid_images_text_mosaic_v1'],
  grid_images_text_mosaic_v1: ['grid_images_text_cards_v1'],
  grid_insights_chart_v1: ['grid_insights_chart_split_v1'],
  grid_insights_chart_split_v1: ['grid_insights_chart_v1'],
  grid_metrics_masonry_v1: ['grid_metrics_asymmetric_v1'],
  grid_metrics_asymmetric_v1: ['grid_metrics_masonry_v1'],
  grid_metrics_mobile_v1: ['grid_metrics_devices_v1'],
  grid_metrics_devices_v1: ['grid_metrics_mobile_v1'],
  grid_six_images_v1: ['grid_six_images_mosaic_v1'],
  grid_six_images_mosaic_v1: ['grid_six_images_v1'],
  grid_text_image_cards_v1: ['grid_text_image_mosaic_v1'],
  grid_text_image_mosaic_v1: ['grid_text_image_cards_v1'],
  grid_three_images_text_v1: ['grid_three_images_text_asymmetric_v1'],
  grid_three_images_text_asymmetric_v1: ['grid_three_images_text_v1'],
  intro_three_para_icons_v1: ['intro_three_para_icons_horizontal_v1'],
  intro_three_para_icons_horizontal_v1: ['intro_three_para_icons_v1'],
  logo_partner_strip_v1: ['logo_partner_grid_v1'],
  logo_partner_grid_v1: ['logo_partner_strip_v1'],
  logo_wall_v1: ['logo_wall_masonry_v1'],
  logo_wall_masonry_v1: ['logo_wall_v1'],
  bullet_list_cards_v1: ['bullet_list_grid_v1'],
  bullet_list_grid_v1: ['bullet_list_cards_v1'],
  bullet_list_numbered_v1: ['bullet_list_numbered_vertical_v1'],
  ...
  comparison_table_v1: ['comparison_table_grid_v1'],
  comparison_table_grid_v1: ['comparison_table_v1'],
  four_images_text_v1: ['four_images_text_mosaic_v1'],
  four_images_text_mosaic_v1: ['four_images_text_v1'],
  four_para_image_v1: ['four_para_image_grid_v1'],
  four_para_image_grid_v1: ['four_para_image_v1'],
  ...
  para_title_left_image_boxed_v1: ['para_title_left_image_overlay_v1'],
  para_title_left_image_overlay_v1: ['para_title_left_image_boxed_v1'],
  para_title_right_image_boxed_v1: ['para_title_right_image_overlay_v1'],
  para_title_right_image_overlay_v1: ['para_title_right_image_boxed_v1'],
  section_divider_band_v1: ['section_divider_band_full_v1'],
  section_divider_band_full_v1: ['section_divider_band_v1'],
  section_divider_numbered_v1: ['section_divider_numbered_circle_v1'],
  section_divider_numbered_circle_v1: ['section_divider_numbered_v1'],
  ...
  section_left_image_v1: ['section_left_image_fullheight_v1'],
  section_left_image_fullheight_v1: ['section_left_image_v1'],
  section_right_image_v1: ['section_right_image_fullheight_v1'],
  section_right_image_fullheight_v1: ['section_right_image_v1'],
  text_two_column_v1: ['text_two_column_split_v1'],
  text_two_column_split_v1: ['text_two_column_v1'],
  title_fullbleed_v1: ['title_fullbleed_overlay_v1'],
  title_fullbleed_overlay_v1: ['title_fullbleed_v1'],
  title_statement_v1: ['title_statement_split_v1'],
  title_statement_split_v1: ['title_statement_v1'],
  ...
  two_para_right_image_v1: ['two_para_right_image_bottom_v1'],
  two_para_right_image_bottom_v1: ['two_para_right_image_v1'],
  wide_image_statement_bottom_v1: ['wide_image_statement_overlay_v1'],
  wide_image_statement_overlay_v1: ['wide_image_statement_bottom_v1'],
}
...
/** Preview keys stamped by *FromSource similar-layout clones. */
const SIMILAR_VARIANT_KEYS = [
  'slideVariant',
  'dataVariant',
  'gridVariant',
  'timelineVariant',
...
/** Values bases may stamp without being treated as similar clones. */
const PRIMARY_VARIANT_ALLOWLIST = {
  pricingVariant: new Set(['default', 'table', 'horizontal']),
  timelineVariant: new Set(['default']),
  agendaVariant: new Set(['default']),
  diagramVariant: new Set(['default']),
  slideVariant: new Set(['default']),
  dataVariant: new Set(['default']),
  gridVariant: new Set(['default']),
}

/**
 * True when schema is a similar-layout clone (non-primary *Variant stamp).
 * Peer bases linked only via LAYOUT_SIMILAR_OVERRIDES stay browse-primary.
 */
export function isSimilarCloneLayout(schemaOrTpl) {
  const schema = schemaOrTpl?.schema || schemaOrTpl
  const preview = schema?.preview || schemaOrTpl?.preview || {}
  for (const key of SIMILAR_VARIANT_KEYS) {
    const raw = preview[key]
    if (raw == null) continue
    const v = String(raw).trim().toLowerCase()
    if (!v) continue
    const allow = PRIMARY_VARIANT_ALLOWLIST[key]
    if (allow ? !allow.has(v) : v !== 'default') return true
  }
  return false
}

export function isBrowsePrimaryLayout(schemaOrTpl) {
  return !isSimilarCloneLayout(schemaOrTpl)
}

/** Filter Add Slide / gallery lists to bases; keep clones on the similar-layouts rail. */
export function filterBrowseLayouts(list = []) {
  if (!Array.isArray(list) || !list.length) return []
  return list.filter((row) => isBrowsePrimaryLayout(row?.schema || row))
}
