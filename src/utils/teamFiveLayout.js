...
export function isTeamFiveLayout(layoutId) {
...
export function teamFiveGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutTeamFive(elements, schema, palette = {}, canvas = {}) {
