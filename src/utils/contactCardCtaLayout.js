...
export function isContactCardCtaLayout(layoutId, schema) {
...
export const CONTACT_CARD_CTA_DEFAULTS = {
...
export function buildContactCardCtaChromeSvg() {
...
export function buildContactCardCtaPillSvg() {
...
export function layoutContactCardCta(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildContactCardCtaCanvasElements({ schema, options = {} } = {}) {
...
export function contactCardCtaPreviewSvg() {
