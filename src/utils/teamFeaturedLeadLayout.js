...
export function isTeamFeaturedLeadLayout(layoutId) {
...
export function teamFeaturedLeadGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutTeamFeaturedLead(elements, schema, palette = {}, canvas = {}) {
