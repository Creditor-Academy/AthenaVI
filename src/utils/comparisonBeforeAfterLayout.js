export function isComparisonBeforeAfterLayout(layoutId) {
...
export function comparisonBeforeAfterGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutComparisonBeforeAfter(docOrElements, schema, themeTokens, canvas = {}) {
