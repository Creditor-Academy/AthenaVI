...
export const CTCC_COLORS = {
  card1: '#3B82F6',  // Blue
  card2: '#8B5CF6',  // Purple
  card3: '#10B981',  // Green
}

export const CTCC_DEFAULTS = {
...
export const isChartThreeContextCardsLayout = (layoutId) => {
  return /chart_three_context_cards_v1$/i.test(String(layoutId || ''))
}

export const isChartThreeContextCardsTextSlot = (slotId) => {
...
const insightIconCircleSvg = (color) => {
...
export const chartThreeContextCardsChromeSpecs = () => {
  const g = CTCC_GEOM
  const card1X = 15
  ...
  return [
    ...
    {
      slotId: 'CTCC_CARD_1_ICON_CIRCLE',
      x: card1X + g.iconX,
      y: g.cardStartY + g.iconY,
      w: g.iconSize,
      h: g.iconSize,
      color: CTCC_COLORS.card1,
      layer: 4,
      kind: 'iconCircle',
    },
    {
      slotId: 'CTCC_CARD_1_ICON',
      x: card1X + g.iconX,
      y: g.cardStartY + g.iconY,
      w: g.iconSize,
      h: g.iconSize,
    ...
    {
      slotId: 'CTCC_CARD_1_INSIGHT_BG',
      x: card1X + g.insightX,
      y: g.cardStartY + g.insightY,
      w: g.insightW,
      h: g.insightH,
      color: CTCC_COLORS.card1,
      layer: 4,
    ...
    {
      slotId: 'CTCC_CARD_1_INSIGHT_ICON_CIRCLE',
      x: card1X + g.insightX + 8,
      y: g.cardStartY + g.insightY + 10,
      w: g.insightIconSize,
      h: g.insightIconSize,
      color: CTCC_COLORS.card1,
      layer: 5,
      kind: 'insightIconCircle',
    },
    {
      slotId: 'CTCC_CARD_1_INSIGHT_ICON',
      x: card1X + g.insightX + 8,
      y: g.cardStartY + g.insightY + 10,
      w: g.insightIconSize,
      h: g.insightIconSize,
    ...
    {
      slotId: 'CTCC_CARD_2_ICON_CIRCLE',
      x: card2X + g.iconX,
      y: g.cardStartY + g.iconY,
      w: g.iconSize,
      h: g.iconSize,
      color: CTCC_COLORS.card2,
      layer: 4,
      kind: 'iconCircle',
    },
    {
      slotId: 'CTCC_CARD_2_ICON',
      x: card2X + g.iconX,
      y: g.cardStartY + g.iconY,
      w: g.iconSize,
      h: g.iconSize,
    ...
    {
      slotId: 'CTCC_CARD_2_INSIGHT_ICON_CIRCLE',
      x: card2X + g.insightX + 8,
      y: g.cardStartY + g.insightY + 10,
      w: g.insightIconSize,
      h: g.insightIconSize,
      color: CTCC_COLORS.card2,
    ...
    {
      slotId: 'CTCC_CARD_2_INSIGHT_ICON',
      x: card2X + g.insightX + 8,
      y: g.cardStartY + g.insightY + 10,
      w: g.insightIconSize,
      h: g.insightIconSize,
    ...
    {
      slotId: 'CTCC_CARD_3_ICON_CIRCLE',
      x: card3X + g.iconX,
      y: g.cardStartY + g.iconY,
      w: g.iconSize,
      h: g.iconSize,
      color: CTCC_COLORS.card3,
      layer: 4,
      kind: 'iconCircle',
    },
    {
      slotId: 'CTCC_CARD_3_ICON',
      x: card3X + g.iconX,
      y: g.cardStartY + g.iconY,
      w: g.iconSize,
      h: g.iconSize,
    ...
    {
      slotId: 'CTCC_CARD_3_INSIGHT_ICON_CIRCLE',
      x: card3X + g.insightX + 8,
      y: g.cardStartY + g.insightY + 10,
      w: g.insightIconSize,
      h: g.insightIconSize,
      color: CTCC_COLORS.card3,
    ...
    {
      slotId: 'CTCC_CARD_3_INSIGHT_ICON',
      x: card3X + g.insightX + 8,
      y: g.cardStartY + g.insightY + 10,
      w: g.insightIconSize,
      h: g.insightIconSize,
...
export const chartThreeContextCardsOverlay = (gx, gy, gw, gh) => {
  const g = CTCC_GEOM
  const sx = gw / g.viewW
  const sy = gh / g.viewH
  const box = (x, y, w, h) => ({
...
export const specToChartThreeContextCardsContent = (spec) => {
...
export const layoutChartThreeContextCards = (elements, schema, palette = {}, canvas = {}) => {
  ...
  const filtered = elements.filter((el) => !chromeRe.test(String(el.slotId || '')) && isChartThreeContextCardsTextSlot(el.slotId))
  ...
  const chrome = chartThreeContextCardsChromeSpecs().map((spec) => {
    const prev = prevBySlot.get(spec.slotId.toUpperCase())
    const graphic = specToChartThreeContextCardsContent(spec)
    if (!graphic) return null
    return {
      id: prev?.id || newId('shp-ctcc'),
      type: 'graphic',
      layer: spec.layer || 4,
      placement: {
  ...
  // Find chart elements
  const chart1El = elements.find((el) => el.slotId === 'CHART_1')
  const chart2El = elements.find((el) => el.slotId === 'CHART_2')
  const chart3El = elements.find((el) => el.slotId === 'CHART_3')
