/**
 * Grid Six Images Layout Engine (Frontend)
 * Layout IDs:
 *  - grid_six_images_v1
 *  - grid_six_images
 *
...
export const GRID_SIX_IMAGES_GEOM = {
  viewW: 1000,
  viewH: 560,
...
export const GRID_SIX_IMAGES_THEMES = [
  {
...
export const GRID_SIX_IMAGES_DEFAULTS = {
  HEADING: 'Comprehensive visual gallery',
  SUBTITLE: 'A curated showcase across six key visual highlights.',
}

export function isGridSixImagesLayout(layoutId) {
 ...
 */
export function buildSixImagesPlaceholderSvg(cardIdx, width, height, radius = 14) {
...
/**
 * Main layout compiler for Grid Six Images (Frontend)
 */
export function layoutGridSixImages(elements, schema, palette = {}, canvas = {}) {
...
/**
 * Polished SVG Preview for Grid Six Images thumbnail
 */
export function gridSixImagesPreviewSvg() {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 90" width="100%" height="100%">
    ...
    <!-- 3x2 Grid -->
    <!-- Row 1 -->
    <rect x="8" y="19" width="45" height="31" rx="2.5" fill="#EEF2FF" stroke="#C7D2FE" stroke-width="0.8"/>
    <rect x="57.5" y="19" width="45" height="31" rx="2.5" fill="#F0FDFA" stroke="#CCFBF1" stroke-width="0.8"/>
    <rect x="107" y="19" width="45" height="31" rx="2.5" fill="#F0F9FF" stroke="#BAE6FD" stroke-width="0.8"/>
    
    <!-- Row 2 -->
    <rect x="8" y="53" width="45" height="31" rx="2.5" fill="#FFFBEB" stroke="#FDE68A" stroke-width="0.8"/>
    <rect x="57.5" y="53" width="45" height="31" rx="2.5" fill="#F5F3FF" stroke="#DDD6FE" stroke-width="0.8"/>
    <rect x="107" y="53" width="45" height="31" rx="2.5" fill="#FFF1F2" stroke="#FECDD3" stroke-width="0.8"/>
  </svg>`
}
