...
import { isTimelineProcessStepsHorizontalLayout, layoutTimelineProcessStepsHorizontal } from './timelineProcessStepsHorizontal.js'
import { isTimelineProcessHorizontalLayout, layoutTimelineProcessHorizontal } from './diagramProcessHorizontal.js'
...
export function applyTimelineConnectorShapes(elements, schema, palette = {}, canvas = {}) {
  ...
  if (isTimelineProcessStepsHorizontalLayout(layoutId)) return elements
...
export function finalizeTimelineShapes(elements, schema, palette = {}, canvas = {}) {
  ...
  if (isTimelineProcessStepsHorizontalLayout(layoutId)) {
    return layoutTimelineProcessStepsHorizontal(elements, schema, palette, canvas)
  }
  if (isTimelineProcessHorizontalLayout(layoutId)) {
    return layoutTimelineProcessHorizontal(elements, schema, palette, canvas)
  }
  ...
  if (isSectionDividerBandFullLayout(layoutId)) {
