/** Team three vertical: Meet the team heading, white/teal split, hex portraits on the divider. */

import { TEAM_HEX_CLIP } from './teamThreeHorizontalLayout.js'

const TEAM_DECO = /^TEAM_(PANEL_BG|HEX_RING|RULE)_/i

export function isTeamThreeVerticalLayout(layoutId) {
  return /team_three_vertical/i.test(String(layoutId || ''))
}

export function teamThreeVerticalGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutTeamThreeVertical(elements, schema, palette = {}, canvas = {}) {
