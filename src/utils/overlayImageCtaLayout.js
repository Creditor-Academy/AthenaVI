...
export function isOverlayImageCtaLayout(layoutId, schema) {
...
export const OVERLAY_IMAGE_CTA_DEFAULTS = {
  HEADING: 'Thank you',
...
export function buildOverlayImageCtaChromeSvg() {
...
export function buildOverlayImageCtaPillSvg() {
...
export function layoutOverlayImageCta(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildOverlayImageCtaCanvasElements({ schema, options = {} } = {}) {
...
export function overlayImageCtaPreviewSvg() {
