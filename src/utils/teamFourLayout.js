/** Team four: left heading, pastel portraits overlapping colored info cards. */
...
export function isTeamFourLayout(layoutId) {
...
export function teamFourGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutTeamFour(elements, schema, palette = {}, canvas = {}) {
