...
export function isSpeakerBioCenteredLayout(layoutId, schema) {
...
export const SPEAKER_BIO_CENTERED_DEFAULTS = {
...
export function buildSpeakerBioCenteredChromeSvg() {
...
export function layoutSpeakerBioCentered(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildSpeakerBioCenteredCanvasElements({ schema, options = {} } = {}) {
...
export function speakerBioCenteredPreviewSvg() {
