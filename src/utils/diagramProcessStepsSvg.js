export const PROCESS_STEP_COLORS = ['#2F5BD6', '#4AA3E0', '#2FCB8A', '#F0B429']

/** Tall band + short fold hang. Arrow is the right ~20%. */
export const PROCESS_RIBBON_VB = { w: 400, h: 148 }
/** Number on the left of the rectangular band. */
export const PROCESS_RIBBON_LABEL = { x: 22, y: 8, w: 210, h: 116 }

export function processRibbonLabelBox(x, y, w, h) {
...
export function processRibbonInlineSvg() {
...
export function processIconInlineSvg(index = 0) {
