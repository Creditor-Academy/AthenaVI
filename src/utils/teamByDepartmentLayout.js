...
export function isTeamByDepartmentLayout(layoutId) {
...
export function teamByDepartmentGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutTeamByDepartment(elements, schema, palette = {}, canvas = {}) {
