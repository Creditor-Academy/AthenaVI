...
export function isContactSplitCtaLayout(layoutId, schema) {
...
export const CONTACT_SPLIT_CTA_DEFAULTS = {
...
export function buildContactSplitCtaChromeSvg() {
...
export function buildContactSplitCtaPillSvg() {
...
export function layoutContactSplitCta(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildContactSplitCtaCanvasElements({ schema, options = {} } = {}) {
...
export function contactSplitCtaPreviewSvg() {
