...
export const BULLET_LIST_NUMBERED_GEOM = {
  viewW: 1000,
  viewH: 560,
  headingY: 22,
  headingH: 36,
...
export const BULLET_LIST_NUMBERED_ITEMS = [
  { color: '#FF7A3C' },
  { color: '#22C5E0' },
  { color: '#F04444' },
  { color: '#6B5CE7' },
...
export const BULLET_LIST_NUMBERED_DEFAULTS = {
  HEADING: 'Five Numbers List',
  TITLE: 'Caption',
  ITEM: 'This slide is an editable slide with all your needs.',
}

export function isBulletListNumberedLayout(layoutId) {
...
export function buildNumberedHexSvg({ width, height, cx, cy, r, number }) {
...
export function layoutBulletListNumbered(docOrElements, schema, palette = {}, canvas = {}) {
...
export function bulletListNumberedPreviewSvg() {
  const geom = BULLET_LIST_NUMBERED_GEOM
  const R = geom.R
