...
export const TEXT_ONLY_CENTERED_GEOM = {
  viewW: 1000,
  viewH: 560,
  headingX: 120,
  headingY: 168,
...
export const TEXT_ONLY_CENTERED_ACCENT = '#148A80'

export const TEXT_ONLY_CENTERED_DEFAULTS = {
  BADGE: 'A NOTE',
...
export function isTextOnlyCenteredLayout(layoutId) {
...
export function buildCenteredOrnamentSvg() {
  const width = 1000
  const height = 560
  const cx = width / 2
...
export function layoutTextOnlyCentered(docOrElements, schema, palette = {}, canvas = {}) {
...
export function textOnlyCenteredPreviewSvg() {
  const g = TEXT_ONLY_CENTERED_GEOM
