export function isTextTwoColumnCardsLayout(layoutId) {
...
export function textTwoColumnCardsGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutTextTwoColumnCards(docOrElements, schema, themeTokens, canvas = {}) {
