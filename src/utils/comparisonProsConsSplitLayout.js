export function isComparisonProsConsSplitLayout(layoutId) {
...
export function comparisonProsConsSplitGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutComparisonProsConsSplit(docOrElements, schema, themeTokens, canvas = {}) {
