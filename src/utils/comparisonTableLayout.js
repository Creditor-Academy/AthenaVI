...
export function isComparisonTableLayout(layoutId) {
  return /comparison_table_(?!grid)[v0-9]+$/i.test(String(layoutId || '')) || /comparison_table_grid/i.test(String(layoutId || ''))
}

export function comparisonTableGeom(canvasW = 1920, canvasH = 1080, isGrid = false) {
...
export function layoutComparisonTable(docOrElements, schema, themeTokens, canvas = {}) {
