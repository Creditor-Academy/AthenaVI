export function isComparisonProsConsLayout(layoutId) {
...
export function comparisonProsConsGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutComparisonProsCons(docOrElements, schema, themeTokens, canvas = {}) {
