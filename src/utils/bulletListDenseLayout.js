...
export const BULLET_LIST_DENSE_GEOM = {
  viewW: 1000,
  viewH: 560,
...
export const BULLET_LIST_DENSE_BARS = [
...
export const BULLET_LIST_DENSE_DEFAULTS = {
...
export function isBulletListDenseLayout(layoutId) {
 ...
 */
export function buildDenseBarSvg({
  width,
  height,
  radius,
  fill,
...
export function layoutBulletListDense(docOrElements, schema, palette = {}, canvas = {}) {
...
export function bulletListDensePreviewSvg() {
  const geom = BULLET_LIST_DENSE_GEOM
