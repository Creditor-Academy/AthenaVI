 ...
 * and Centerline (vertical rule).
 */

export function isComparisonSideBySideCardsLayout(layoutId, schema) {
...
export const COMPARISON_SIDE_BY_SIDE_CARDS_DEFAULTS = {
...
export function buildComparisonSideBySideCardsChromeSvg() {
...
export function layoutComparisonSideBySideCards(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildComparisonSideBySideCardsCanvasElements({ schema, options = {} } = {}) {
...
export function comparisonSideBySideCardsPreviewSvg() {
