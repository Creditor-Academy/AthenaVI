...
export function isCenteredTextCtaLayout(layoutId, schema) {
...
export const CENTERED_TEXT_CTA_DEFAULTS = {
  HEADING: 'Thank you',
...
export function buildCenteredTextCtaChromeSvg() {
...
export function buildCenteredTextCtaPillSvg() {
...
export function layoutCenteredTextCta(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildCenteredTextCtaCanvasElements({ schema, options = {} } = {}) {
...
export function centeredTextCtaPreviewSvg() {
