export const QUOTE_GRID_N = 3
export const QUOTE_MARK_COLOR = '#1E3A5F'
export const QUOTE_CARD_BORDER = '#E5E7EB'

export function quoteMarkInlineSvg() {
...
export function quoteGridFrame(canvasW, canvasH, n = QUOTE_GRID_N) {
  const insetX = 56
  const insetY = 44
  const headingH = 72
  const gap = 28
...
export function quoteGridCardGeom(i, frame) {
...
export function quotePortraitGeom(canvasW, canvasH) {
  const insetX = 96
  const insetY = 88
...
export function quoteStatementLeftGeom(canvasW, canvasH) {
  const insetX = 96
  const insetY = 88
  const cardW = canvasW - insetX * 2
  const cardH = canvasH - insetY * 2
...
export function quoteTestimonialGeom(canvasW, canvasH) {
...
export function quoteAttributionSplitGeom(canvasW, canvasH) {
  const insetX = 72
  const insetY = 64
  const cardW = canvasW - insetX * 2
  const cardH = canvasH - insetY * 2
