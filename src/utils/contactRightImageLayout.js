...
export function isContactRightImageLayout(layoutId, schema) {
...
export const CONTACT_RIGHT_IMAGE_DEFAULTS = {
  HEADING: 'Contact me',
...
export function buildContactRightImageChromeSvg() {
  const {
...
export function layoutContactRightImage(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildContactRightImageCanvasElements({ schema, options = {} } = {}) {
...
export function contactRightImagePreviewSvg() {
