...
import { horizontalTimelineInlineSvg } from './timelineProcessSvg.js'
import {
  AGENDA_GEOM,
  AGENDA_ICON_KEYS,
  AGENDA_LAYOUT_META,
...
import { agendaMinimalChromeSpecs, agendaMinimalOverlayPlacements } from './agendaMinimalSvg.js'
import { agendaNumberedChromeSpecs, agendaNumberedOverlayPlacements } from './agendaNumberedSvg.js'
import { agendaColumnsChromeSpecs, agendaColumnsOverlayPlacements } from './agendaColumnsSvg.js'
import { agendaTimelineChromeSpecs, agendaTimelineOverlayPlacements } from './agendaTimelineSvg.js'
import { agendaTwoColumnChromeSpecs, agendaTwoColumnOverlayPlacements } from './agendaTwoColumnSvg.js'
import {
...
export function agendaOverlayPlacements(gx, gy, gw, gh, family, variant, opts = {}) {
  switch (family) {
    case 'minimal':
...
export function agendaDiagramInlineSvg(family, variant, colors = {}, opts = {}) {
...
export function agendaPreviewSvgFromSchema(schema, colors = {}) {
...
export function specToGraphicContent(spec, accent, soft) {
