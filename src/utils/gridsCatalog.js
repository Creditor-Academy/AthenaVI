...
const CATALOG = {
  ...
  grid_images_text_cards_v1: layoutBase('grid_images_text_cards_v1', 'grid', [
    slot('COL_1_IMAGE', 'cols 1-4, rows 1-5', 'image', null, { layer: 2, fit: 'cover' }),
    heading('COL_1_TITLE', 'cols 1-4, rows 5-6', 'Feature A', {
      typography: typo('heading', { fontSize: 20 }),
    }),
    body('COL_1_BODY', 'cols 1-4, rows 6-8', P.short, 3, { typography: typo('body', { fontSize: 14 }) }),
    slot('COL_2_IMAGE', 'cols 5-8, rows 1-5', 'image', null, { layer: 2, fit: 'cover' }),
    heading('COL_2_TITLE', 'cols 5-8, rows 5-6', 'Feature B', {
      typography: typo('heading', { fontSize: 20 }),
    }),
    body('COL_2_BODY', 'cols 5-8, rows 6-8', P.short, 3, { typography: typo('body', { fontSize: 14 }) }),
    slot('COL_3_IMAGE', 'cols 9-12, rows 1-5', 'image', null, { layer: 2, fit: 'cover' }),
    heading('COL_3_TITLE', 'cols 9-12, rows 5-6', 'Feature C', {
      typography: typo('heading', { fontSize: 20 }),
    }),
    body('COL_3_BODY', 'cols 9-12, rows 6-8', P.short, 3, { typography: typo('body', { fontSize: 14 }) }),
  ...
  grid_metrics_masonry_v1: layoutBase('grid_metrics_masonry_v1', 'grid', [
    heading('HEADING', 'cols 1-12, rows 1-2', 'Performance highlights', {
      typography: typo('heading', { fontSize: 28 }),
    }),
    cardShapeHint('cols 1-5, rows 3-6', 'METRIC_CARD_1_BG', 12),
    heading('METRIC_TITLE_1', 'cols 1-5, rows 3-4', 'Describe this feature', {
      typography: typo('heading', { fontSize: 18 }),
    }),
    body('METRIC_BODY_1', 'cols 1-5, rows 4-5', P.short, 2, { typography: typo('body', { fontSize: 13 }) }),
    slot('METRIC_IMAGE_1', 'cols 1-5, rows 5-6', 'image', null, { layer: 2, fit: 'cover', imageStyle: 'card' }),
    cardShapeHint('cols 6-12, rows 3-4', 'METRIC_CARD_2_BG', 12),
    slot('STAT_2_VALUE', 'cols 6-8, rows 3-4', 'stat', '95%', {
      layer: 10,
      typography: typo('stat', { fontSize: 44, align: 'left' }),
      max_lines: 1,
    }),
    slot('STAT_2_LABEL', 'cols 9-12, rows 3-4', 'stat_label', 'Explain the meaning of this metric', {
      layer: 10,
      typography: typo('caption', { align: 'left' }),
      max_lines: 3,
    }),
    cardShapeHint('cols 6-8, rows 5-6', 'METRIC_CARD_3_BG', 12),
    slot('METRIC_IMAGE_2', 'cols 6-8, rows 5-6', 'image', null, { layer: 2, fit: 'cover', imageStyle: 'card' }),
    cardShapeHint('cols 1-8, rows 7-8', 'METRIC_CARD_4_BG', 12),
    slot('STAT_1_VALUE', 'cols 1-3, rows 7-8', 'stat', '100k', {
      layer: 10,
      typography: typo('stat', { fontSize: 44, align: 'left' }),
      max_lines: 1,
    }),
    slot('STAT_1_LABEL', 'cols 4-8, rows 7-8', 'stat_label', 'Explain the meaning of this metric', {
      layer: 10,
      typography: typo('caption', { align: 'left' }),
      max_lines: 3,
    }),
    cardShapeHint('cols 9-12, rows 5-10', 'METRIC_CARD_5_BG', 12),
    heading('METRIC_TITLE_3', 'cols 9-12, rows 5-6', 'Describe this feature', {
      typography: typo('heading', { fontSize: 18 }),
    }),
    body('METRIC_BODY_3', 'cols 9-12, rows 6-7', P.short, 2, { typography: typo('body', { fontSize: 13 }) }),
    slot('METRIC_IMAGE_3', 'cols 9-12, rows 7-10', 'image', null, { layer: 2, fit: 'cover', imageStyle: 'card' }),
