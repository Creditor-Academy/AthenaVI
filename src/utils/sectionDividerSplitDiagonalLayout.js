...
export const SECTION_DIVIDER_SPLIT_DIAGONAL_GEOM = {
  viewW: 1000,
  viewH: 560,
  numberX: 48,
  numberY: 70,
...
export const SECTION_DIVIDER_SPLIT_DIAGONAL_ACCENT = '#148A80'

export const SECTION_DIVIDER_SPLIT_DIAGONAL_DEFAULTS = {
  SECTION_NUMBER: '02',
  EYEBROW: 'SECTION',
...
export function isSectionDividerSplitDiagonalLayout(layoutId) {
...
export function buildSplitDiagonalChromeSvg() {
  const width = 1000
  const height = 560
...
export function layoutSectionDividerSplitDiagonal(docOrElements, schema, palette = {}, canvas = {}) {
...
export function sectionDividerSplitDiagonalPreviewSvg() {
  const g = SECTION_DIVIDER_SPLIT_DIAGONAL_GEOM
