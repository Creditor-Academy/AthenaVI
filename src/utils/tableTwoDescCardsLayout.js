...
export const TABLE_TWO_DESC_CARDS_GEOM = {
  viewW: 1000,
  viewH: 560,
...
export const TABLE_TWO_DESC_CARDS_PALETTE = {
...
export const TABLE_TWO_DESC_CARDS_DEFAULTS = {
...
export function isTableTwoDescCardsLayout(layoutId) {
 ...
 */
export function buildTableTwoDescCardsSvgChrome(palette = TABLE_TWO_DESC_CARDS_PALETTE) {
  const g = TABLE_TWO_DESC_CARDS_GEOM
...
export function tableTwoDescCardsChromeSpecs(palette = TABLE_TWO_DESC_CARDS_PALETTE) {
  const g = TABLE_TWO_DESC_CARDS_GEOM
  const t1Color = palette.t1Primary || TABLE_TWO_DESC_CARDS_PALETTE.t1Primary
  const t2Color = palette.t2Primary || TABLE_TWO_DESC_CARDS_PALETTE.t2Primary
  return [
...
export function tableTwoDescCardsOverlay(canvasW, canvasH) {
  const g = TABLE_TWO_DESC_CARDS_GEOM
...
export function specToTableTwoDescCardsContent(spec, palette = TABLE_TWO_DESC_CARDS_PALETTE) {
...
export function tableTwoDescCardsPreviewSvg() {
 ...
 */
export function layoutTableTwoDescCards(elements, schema, palette = {}, canvas = {}) {
