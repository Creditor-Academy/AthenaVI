/**
 * Grid Six Images Mosaic Layout Engine (Frontend)
 * Layout IDs:
...
export const GRID_SIX_IMAGES_MOSAIC_GEOM = {
  viewW: 1000,
  viewH: 560,
...
export const GRID_SIX_IMAGES_MOSAIC_THEMES = [
  {
...
export const GRID_SIX_IMAGES_MOSAIC_DEFAULTS = {
  HEADING: 'Dynamic visual mosaic',
  SUBTITLE: 'An interlocking six-part visual showcase across focus areas.',
}

export function isGridSixImagesMosaicLayout(layoutId) {
 ...
 */
export function buildSixImagesMosaicPlaceholderSvg(cardIdx, width, height, radius = 14) {
...
/**
 * Main layout compiler for Grid Six Images Mosaic (Frontend)
 */
export function layoutGridSixImagesMosaic(docOrElements, schema, palette = {}, canvas = {}) {
...
/**
 * Polished SVG Preview for Grid Six Images Mosaic thumbnail
 */
export function gridSixImagesMosaicPreviewSvg() {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 90" width="100%" height="100%">
    <rect width="160" height="90" fill="#FFFFFF"/>
    <!-- Header -->
    <rect x="8" y="6" width="60" height="4.5" rx="1.5" fill="#1E293B"/>
    <rect x="8" y="12.5" width="85" height="3" rx="1" fill="#94A3B8"/>
    
    <!-- Alternating Wave Mosaic -->
    <!-- Col 1 -->
    <rect x="8" y="19" width="45" height="38" rx="2.5" fill="#EEF2FF" stroke="#C7D2FE" stroke-width="0.8"/>
    <rect x="8" y="60" width="45" height="24" rx="2.5" fill="#FFF1F2" stroke="#FECDD3" stroke-width="0.8"/>
    
    <!-- Col 2 -->
    <rect x="57.5" y="19" width="45" height="24" rx="2.5" fill="#F0FDFA" stroke="#CCFBF1" stroke-width="0.8"/>
    <rect x="57.5" y="46" width="45" height="38" rx="2.5" fill="#F5F3FF" stroke="#DDD6FE" stroke-width="0.8"/>
    
    <!-- Col 3 -->
    <rect x="107" y="19" width="45" height="38" rx="2.5" fill="#F0F9FF" stroke="#BAE6FD" stroke-width="0.8"/>
    <rect x="107" y="60" width="45" height="24" rx="2.5" fill="#FFFBEB" stroke="#FDE68A" stroke-width="0.8"/>
  </svg>`
}
