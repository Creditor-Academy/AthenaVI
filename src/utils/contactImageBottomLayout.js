...
export function isContactImageBottomLayout(layoutId, schema) {
...
export const CONTACT_IMAGE_BOTTOM_DEFAULTS = {
  HEADING: 'Contact me',
...
export function buildContactImageBottomChromeSvg() {
...
export function layoutContactImageBottom(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildContactImageBottomCanvasElements({ schema, options = {} } = {}) {
...
export function contactImageBottomPreviewSvg() {
