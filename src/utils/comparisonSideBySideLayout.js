...
export function isComparisonSideBySideLayout(layoutId, schema) {
...
export function isComparisonSideBySideTwinLayout(layoutId, schema) {
  const id = String(layoutId || schema?.layout_id || schema?.layoutId || '').toLowerCase()
  return id === 'comparison_side_by_side_centerline_v1' || id === 'comparison_side_by_side_centerline'
}

export const COMPARISON_SIDE_BY_SIDE_DEFAULTS = {
...
export function buildComparisonSideBySideChromeSvg() {
...
export function layoutComparisonSideBySide(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildComparisonSideBySideCanvasElements({ schema, options = {} } = {}) {
...
export function comparisonSideBySidePreviewSvg() {
...
export function comparisonSideBySideGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutComparisonSideBySideTwin(docOrElements, schema, themeTokens, canvas = {}) {
  const elements = Array.isArray(docOrElements) ? docOrElements : docOrElements?.elements
