...
const LAYOUT_PREVIEW_MODES = {
  ...
  eight_short_texts_image_center_v1: 'eight_short_texts',
  ...
  intro_three_para_icons_horizontal_v1: 'intro_three_para_icons',
  intro_three_para_icons_radial_v1: 'intro_three_para_icons',
  // Grids
  grid_bento_three_v1: 'grid_bento_three',
  grid_three_asymmetric_v1: 'grid_bento_three',
  grid_three_staggered_v1: 'grid_bento_three',
  grid_bento_four_v1: 'grid_bento_four',
  grid_four_asymmetric_v1: 'grid_bento_four',
  grid_four_mosaic_v1: 'grid_bento_four',
  grid_six_images_v1: 'grid_six_images',
  grid_six_images_mosaic_v1: 'grid_six_images',
  grid_six_images_staggered_v1: 'grid_six_images',
  grid_text_image_cards_v1: 'grid_text_image_cards',
  grid_text_image_split_v1: 'grid_text_image_cards',
  grid_text_image_mosaic_v1: 'grid_text_image_cards',
  grid_three_images_text_v1: 'grid_three_images_text',
  grid_three_images_text_horizontal_v1: 'grid_three_images_text',
  grid_three_images_text_asymmetric_v1: 'grid_three_images_text',
  grid_images_text_cards_v1: 'grid_images_text_cards',
  grid_images_text_split_v1: 'grid_images_text_cards',
  grid_images_text_mosaic_v1: 'grid_images_text_cards',
  grid_insights_chart_v1: 'grid_insights_chart',
  grid_insights_chart_split_v1: 'grid_insights_chart',
  grid_insights_chart_focus_v1: 'grid_insights_chart',
  grid_metrics_mobile_v1: 'grid_metrics_mobile',
  grid_metrics_devices_v1: 'grid_metrics_mobile',
  grid_metrics_phone_stack_v1: 'grid_metrics_mobile',
  grid_metrics_masonry_v1: 'grid_metrics_masonry',
  grid_metrics_asymmetric_v1: 'grid_metrics_masonry',
  grid_metrics_staggered_v1: 'grid_metrics_masonry',
  grid_device_mockups_v1: 'grid_device_mockups',
  grid_device_mockups_staggered_v1: 'grid_device_mockups',
  grid_device_mockups_feature_v1: 'grid_device_mockups',
  logo_wall_v1: 'grid_six_images',
  logo_wall_masonry_v1: 'grid_six_images',
  logo_wall_centered_v1: 'grid_six_images',
  logo_partner_strip_v1: 'grid_three_images',
  logo_partner_grid_v1: 'grid_three_images',
  logo_partner_wall_v1: 'grid_three_images',
  // Charts & data
  ...
  chart_donut_context_right_v1: 'chart_donut_split',
  chart_donut_context_bottom_v1: 'chart_donut_split',
  chart_three_donut_v1: 'chart_donut_row',
  chart_three_donut_horizontal_v1: 'chart_donut_row',
  chart_three_donut_cards_v1: 'chart_donut_row',
  chart_exponential_desc_side_v1: 'chart_split',
  chart_exponential_desc_bottom_v1: 'chart_split',
  chart_with_description_side_v1: 'chart_split',
  chart_with_description_bottom_v1: 'chart_split',
  chart_single_large_v1: 'chart_full_width',
  chart_single_split_v1: 'chart_full_width',
  chart_three_context_cards_v1: 'chart_triple_context',
  chart_three_context_horizontal_v1: 'chart_triple_context',
  chart_three_horizontal_v1: 'chart_triple',
  chart_three_cards_v1: 'chart_triple',
  chart_two_cards_horizontal_v1: 'chart_card_grid',
  chart_two_cards_split_v1: 'chart_card_grid',
  chart_two_horizontal_v1: 'chart_dual',
  chart_two_split_v1: 'chart_dual',
  table_single_v1: 'table_preview',
  table_single_cards_v1: 'table_preview',
  table_single_matrix_v1: 'table_preview',
  table_with_description_v1: 'table_with_desc',
  table_with_description_side_v1: 'table_with_desc',
  table_with_description_top_v1: 'table_with_desc',
  table_two_desc_v1: 'table_dual',
  table_two_desc_split_v1: 'table_dual',
  ...
  table_two_same_header_split_v1: 'table_dual_shared_header',
  ...
  process_linear_horizontal_four_v1: 'process_linner_horti',
  process_linear_four_cards_v1: 'process_linner_horti',
  process_linear_horizontal_v2: 'process_linner_horti',
  process_linear_path_v1: 'process_linner_horti',
  process_linear_numeric_cards_v1: 'process_linner_numeric',
  process_linear_numeric_path_v1: 'process_linner_numeric',
  timeline_horizontal_v1: 'timeline_horizontal',
  timeline_horizontal_nodes_v1: 'timeline_horizontal',
  timeline_horizontal_cards_v1: 'timeline_horizontal',
  timeline_milestones_v1: 'timeline_horizontal',
  timeline_milestones_cards_v1: 'timeline_horizontal',
  timeline_milestones_path_v1: 'timeline_horizontal',
  timeline_milestones_image_v1: 'timeline_milestones_image',
  timeline_milestones_image_right_v1: 'timeline_milestones_image',
  timeline_milestones_image_top_v1: 'timeline_milestones_image',
  timeline_vertical_v1: 'timeline_vertical',
  timeline_vertical_nodes_v1: 'timeline_vertical',
  timeline_vertical_cards_v1: 'timeline_vertical',
  timeline_roadmap_v1: 'timeline_roadmap',
  timeline_roadmap_horizontal_v1: 'timeline_roadmap',
  timeline_roadmap_lanes_v1: 'timeline_roadmap',
  timeline_process_steps_v1: 'timeline_process_steps',
  timeline_process_horizontal_v1: 'timeline_process_steps',
  timeline_process_vertical_v1: 'timeline_process_steps',
  ...
  section_divider_centered_large_v1: 'section_divider',
  section_divider_centered_frame_v1: 'section_divider',
  bullet_list_dense_v1: 'bullet_list',
  bullet_list_numbered_v1: 'bullet_list',
  bullet_list_numbered_vertical_v1: 'bullet_list',
  bullet_list_numbered_path_v1: 'bullet_list',
  bullet_list_two_column_v1: 'comparison_columns',
  bullet_list_split_v1: 'comparison_columns',
  bullet_list_two_column_cards_v1: 'comparison_columns',
  text_only_centered_v1: 'bullet_list',
  text_two_column_v1: 'comparison_columns',
  text_two_column_split_v1: 'comparison_columns',
  text_two_column_balanced_v1: 'comparison_columns',
  title_minimal_v1: 'title_centered',
  title_minimal_centered_v1: 'title_centered',
  title_minimal_offset_v1: 'title_centered',
  title_statement_v1: 'title_centered',
  title_statement_large_v1: 'title_centered',
  title_statement_split_v1: 'title_centered',
  title_fullbleed_v1: 'title_centered',
  title_fullbleed_image_v1: 'title_centered',
  title_fullbleed_overlay_v1: 'title_centered',
  title_hero_left_blob_v1: 'title_centered',
  title_hero_left_shape_v1: 'title_centered',
  title_hero_left_orbit_v1: 'title_centered',
  title_hero_left_fade_v1: 'title_centered',
  title_hero_left_gradient_v1: 'title_centered',
  title_hero_left_glow_v1: 'title_centered',
  title_hero_right_fade_v1: 'title_centered',
  title_hero_right_gradient_v1: 'title_centered',
  title_hero_right_glow_v1: 'title_centered',
  title_with_logo_v1: 'title_centered',
  title_with_logo_corner_v1: 'title_centered',
  title_with_logo_centered_v1: 'title_centered',
  headline_centered_v1: 'title_centered',
  headline_centered_statement_v1: 'title_centered',
  headline_centered_frame_v1: 'title_centered',
  four_images_text_v1: 'image_gallery_three',
  four_images_text_grid_v1: 'image_gallery_three',
  four_images_text_mosaic_v1: 'image_gallery_three',
  four_para_image_v1: 'bullet_list',
  four_para_image_grid_v1: 'bullet_list',
  four_para_image_quadrant_v1: 'bullet_list',
  ...
  para_landscape_image_v1: 'two_image_columns',
  ...
  para_title_left_image_boxed_v1: 'closing_image_left',
  para_title_left_image_framed_v1: 'closing_image_left',
  para_title_left_image_overlay_v1: 'closing_image_left',
  para_title_right_image_boxed_v1: 'closing_image_right',
  para_title_right_image_framed_v1: 'closing_image_right',
  para_title_right_image_overlay_v1: 'closing_image_right',
  section_left_image_v1: 'closing_image_left',
  section_left_image_framed_v1: 'closing_image_left',
  section_left_image_fullheight_v1: 'closing_image_left',
  section_right_image_v1: 'closing_image_right',
  section_right_image_framed_v1: 'closing_image_right',
  section_right_image_fullheight_v1: 'closing_image_right',
  two_para_right_image_v1: 'closing_image_right',
  two_para_right_image_bottom_v1: 'closing_image_right',
  two_para_right_image_framed_v1: 'closing_image_right',
  wide_image_statement_bottom_v1: 'closing_overlay',
  wide_image_statement_overlay_v1: 'closing_overlay',
  wide_image_statement_center_v1: 'closing_overlay',
  ...
  metric_single_hero_v1: 'stat_hero',
  metric_single_split_v1: 'stat_hero',
  metric_two_v1: 'stat_row',
  metric_two_horizontal_v1: 'stat_row',
  metric_two_split_v1: 'stat_row',
  metric_three_v1: 'stat_row',
  metric_three_horizontal_v1: 'stat_row',
  metric_three_cards_v1: 'stat_row',
  metric_four_v1: 'stat_row',
  metric_four_horizontal_v1: 'stat_row',
  metric_four_cards_v1: 'stat_row',
  metric_five_v1: 'stat_row',
  metric_five_horizontal_v1: 'stat_row',
  metric_five_cards_v1: 'stat_row',
  metric_six_para_v1: 'stat_six_para',
  metric_six_cards_v1: 'stat_six_para',
  metric_six_grid_v1: 'stat_six_para',
  metric_three_vertical_v1: 'stat_vertical',
  metric_three_vertical_cards_v1: 'stat_vertical',
  metric_three_vertical_nodes_v1: 'stat_vertical',
  // Pricing
...
function mergeRegistryPreviewFallback(schema) {
  ...
  merged.preview = {
    ...
    timelineVariant: mp.timelineVariant ?? rp.timelineVariant,
    dataVariant: mp.dataVariant ?? rp.dataVariant,
    gridVariant: mp.gridVariant ?? rp.gridVariant,
    slideVariant: mp.slideVariant ?? rp.slideVariant,
  }
