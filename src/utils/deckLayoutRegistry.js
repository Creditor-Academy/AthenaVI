 ...
 * Merged via deckLayoutCatalogs.js — keep in sync with export-seed-layouts.mjs.
 */
...
const LAYOUT_PREVIEW_MODES = {
  title_hero_right_oval_v1: 'title_hero_right_oval',
  title_with_logo_v1: 'title_with_logo',
  ...
  large_image_v1: 'large_image',
  centered_text_cta_v1: 'centered_text_cta',
  para_image_cta_v1: 'para_image_cta',
  intro_four_para_v1: 'intro_four_para',
  headline_right_text_v1: 'headline_right_text',
  ...
  comparison_side_by_side_v1: 'comparison_side_by_side',
  comparison_side_by_side_cards_v1: 'comparison_side_by_side_cards',
  comparison_side_by_side_centerline_v1: 'comparison_side_by_side_centerline',
  ...
  title_minimal_v1: 'title_minimal',
  title_statement_v1: 'title_statement',
  title_statement_split_v1: 'title_statement_split',
  title_fullbleed_v1: 'title_fullbleed',
  title_fullbleed_overlay_v1: 'title_fullbleed_overlay',
  title_hero_left_blob_v1: 'title_hero_left_blob',
  title_hero_left_fade_v1: 'title_hero_left_fade',
  title_hero_right_oval_v1: 'title_hero_right_oval',
  title_hero_right_fade_v1: 'title_hero_right_fade',
  title_with_logo_v1: 'title_with_logo',
  title_with_logo_corner_v1: 'title_with_logo',
  title_with_logo_centered_v1: 'title_with_logo',
  headline_centered_v1: 'headline_centered',
  four_images_text_v1: 'four_images_text',
  ...
  para_landscape_image_top_v1: 'para_landscape_image_top',
  para_landscape_image_bottom_v1: 'para_landscape_image_bottom',
  ...
  para_title_right_image_overlay_v1: 'para_title_right_image_overlay',
  section_left_image_v1: 'section_left_image',
  section_left_image_fullheight_v1: 'section_left_image_fullheight',
  section_right_image_v1: 'section_right_image',
  section_right_image_fullheight_v1: 'section_right_image_fullheight',
  two_para_right_image_v1: 'two_para_right_image',
  two_para_right_image_bottom_v1: 'two_para_right_image_bottom',
  wide_image_statement_top_v1: 'wide_image_statement_top',
  wide_image_statement_bottom_v1: 'wide_image_statement_bottom',
  wide_image_statement_overlay_v1: 'wide_image_statement_overlay',
  closing_thank_you_v1: 'closing_thank_you',
  closing_contact_cta_v1: 'closing_contact_cta',
  minimal_text_cta_v1: 'minimal_text_cta',
  contact_card_cta_v1: 'contact_card_cta',
  contact_split_cta_v1: 'contact_split_cta',
  contact_image_bottom_v1: 'contact_image_bottom',
  team_speaker_bio_v1: 'team_speaker_bio',
  speaker_bio_image_right_v1: 'speaker_bio_image_right',
  speaker_bio_centered_v1: 'speaker_bio_centered',
  image_para_cta_v1: 'image_para_cta',
  overlay_image_cta_v1: 'overlay_image_cta',
  ...
  metric_single_v1: 'metric_single_v1',
  metric_single_split_v1: 'metric_single_split_v1',
  metric_two_v1: 'metric_two_v1',
  metric_two_split_v1: 'metric_two_split_v1',
  metric_three_v1: 'metric_three_v1',
  metric_three_cards_v1: 'metric_three_cards_v1',
  metric_four_v1: 'metric_four_v1',
  metric_four_cards_v1: 'metric_four_cards_v1',
  metric_five_v1: 'metric_five_v1',
  metric_five_cards_v1: 'metric_five_cards_v1',
  metric_six_para_v1: 'metric_six_para_v1',
  metric_six_cards_v1: 'metric_six_cards_v1',
  metric_three_vertical_v1: 'metric_three_vertical_v1',
  metric_three_vertical_cards_v1: 'metric_three_vertical_cards_v1',
  // Pricing
  ...
  contact_left_image_v1: 'contact_left_image',
  contact_right_image_v1: 'contact_right_image',
