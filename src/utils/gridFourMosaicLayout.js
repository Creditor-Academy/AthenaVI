/**
 * Grid Four Mosaic Layout Engine (Frontend)
 * Layout IDs:
 *  - grid_four_mosaic_v1
 *  - grid_four_mosaic
 *
...
export const GRID_FOUR_MOSAIC_GEOM = {
  viewW: 1000,
  viewH: 560,
...
export const GRID_FOUR_MOSAIC_THEMES = [
  {
...
export const GRID_FOUR_MOSAIC_DEFAULTS = {
  HEADING: 'Curated visual mosaic',
  SUBTITLE: 'An interlocking visual showcase across creative focus areas.',
}

export function isGridFourMosaicLayout(layoutId) {
 ...
 */
export function buildMosaicPlaceholderSvg(cardIdx, width, height, radius = 14) {
...
/**
 * Main layout compiler for Grid Four Mosaic (Frontend)
 */
export function layoutGridFourMosaic(elements, schema, palette = {}, canvas = {}) {
...
/**
 * Polished SVG Preview for Grid Four Mosaic thumbnail
 */
export function gridFourMosaicPreviewSvg() {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 90" width="100%" height="100%">
    ...
    <!-- Mosaic Grid: Staggered Interlocking -->
    <!-- Left Column -->
    <rect x="8" y="19" width="69" height="38" rx="2.5" fill="#EEF2FF" stroke="#C7D2FE" stroke-width="0.8"/>
    <rect x="8" y="60" width="69" height="24" rx="2.5" fill="#F0FDFA" stroke="#CCFBF1" stroke-width="0.8"/>
    
    <!-- Right Column -->
    <rect x="83" y="19" width="69" height="24" rx="2.5" fill="#F0F9FF" stroke="#BAE6FD" stroke-width="0.8"/>
    <rect x="83" y="46" width="69" height="38" rx="2.5" fill="#FFFBEB" stroke="#FDE68A" stroke-width="0.8"/>
  </svg>`
}
