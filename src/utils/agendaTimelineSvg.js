...
export function timelineVariantFromSchema(schema) {
...
export function agendaTimelineChromeSpecs(variant = 'default', itemCount = 4) {
  if (variant !== 'vertical' && variant !== 'curved' && variant !== 'path') {
...
export function agendaTimelineOverlayPlacements(gx, gy, gw, gh, variant = 'default', opts = {}) {
  if (variant !== 'vertical' && variant !== 'curved' && variant !== 'path') {
