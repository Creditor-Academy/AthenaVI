/** Left copy + portrait tablet, inset from the slide edge (not stretched square). */

export function isDeviceTabletSplitLayout(layoutId) {
...
export function layoutDeviceTabletSplit(elements, schema, palette = {}, canvas = {}) {
