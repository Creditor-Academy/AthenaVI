...
export const DECK_LAYOUT_STARTERS = {
  ...
  metric_four: {
    label: 'Four metrics row',
    suggestedName: 'Metric Four',
    contentType: 'stat',
    schema: {
      layout_id: 'metric_four_v1',
      content_type: 'stat',
      schemaVersion: 2,
      grid: '12-col',
      preview: { mode: 'metric_four_v1' },
      slots: [
        slot('HEADING', 'cols 2-11, rows 1-2', 'heading', 'Key metrics'),
        slot('STAT_1_VALUE', 'cols 1-3, rows 4-5', 'stat', '98%'),
        slot('STAT_1_LABEL', 'cols 1-3, rows 5-7', 'stat_label', 'Satisfaction'),
        slot('STAT_2_VALUE', 'cols 4-6, rows 4-5', 'stat', '3.2x'),
        slot('STAT_2_LABEL', 'cols 4-6, rows 5-7', 'stat_label', 'ROI'),
        slot('STAT_3_VALUE', 'cols 7-9, rows 4-5', 'stat', '500+'),
        slot('STAT_3_LABEL', 'cols 7-9, rows 5-7', 'stat_label', 'Teams'),
        slot('STAT_4_VALUE', 'cols 10-12, rows 4-5', 'stat', '24h'),
        slot('STAT_4_LABEL', 'cols 10-12, rows 5-7', 'stat_label', 'Response'),
      ],
    },
  },
  metric_five: {
    label: 'Five metrics row',
    suggestedName: 'Metric Five',
    contentType: 'stat',
    schema: {
      layout_id: 'metric_five_v1',
      content_type: 'stat',
      schemaVersion: 2,
      grid: '12-col',
      preview: { mode: 'metric_five_v1' },
      slots: [
        slot('HEADING', 'cols 2-11, rows 1-2', 'heading', 'Key metrics'),
        slot('STAT_1_VALUE', 'cols 1-2, rows 4-5', 'stat', '98%'),
        slot('STAT_1_LABEL', 'cols 1-2, rows 5-7', 'stat_label', 'Satisfaction'),
        slot('STAT_2_VALUE', 'cols 3-5, rows 4-5', 'stat', '3.2x'),
        slot('STAT_2_LABEL', 'cols 3-5, rows 5-7', 'stat_label', 'ROI'),
        slot('STAT_3_VALUE', 'cols 6-8, rows 4-5', 'stat', '500+'),
        slot('STAT_3_LABEL', 'cols 6-8, rows 5-7', 'stat_label', 'Teams'),
        slot('STAT_4_VALUE', 'cols 9-10, rows 4-5', 'stat', '24h'),
        slot('STAT_4_LABEL', 'cols 9-10, rows 5-7', 'stat_label', 'Response'),
        slot('STAT_5_VALUE', 'cols 11-12, rows 4-5', 'stat', '12'),
        slot('STAT_5_LABEL', 'cols 11-12, rows 5-7', 'stat_label', 'Markets'),
      ],
    },
  },
  table_single: {
  ...
  team_three: {
    ...
    schema: {
      ...
      slots: [
        slot('HEADING', 'cols 1-12, rows 1-1', 'heading', 'Meet the team'),
        slot('MEMBER_1_IMAGE', 'cols 1-4, rows 2-6', 'image'),
        slot('MEMBER_1_NAME', 'cols 1-4, rows 7-7', 'heading', 'Johanna Doe'),
        slot('MEMBER_1_ROLE', 'cols 1-4, rows 8-8', 'caption', 'CEO'),
        slot('MEMBER_2_IMAGE', 'cols 5-8, rows 2-6', 'image'),
        slot('MEMBER_2_NAME', 'cols 5-8, rows 7-7', 'heading', 'Jane Doe'),
        slot('MEMBER_3_IMAGE', 'cols 9-12, rows 2-6', 'image'),
        slot('MEMBER_3_NAME', 'cols 9-12, rows 7-7', 'heading', 'Joe Doe'),
      ],
    },
  },
  contact_split: {
