...
export const TABLE_TWO_DESC_GEOM = {
  viewW: 1000,
  viewH: 560,
...
export const TABLE_TWO_DESC_PALETTE = {
...
export const TABLE_TWO_DESC_DEFAULTS = {
...
export function isTableTwoDescLayout(layoutId) {
 ...
 */
export function buildTableTwoDescSvgChrome(palette = TABLE_TWO_DESC_PALETTE) {
...
export function tableTwoDescChromeSpecs() {
  const g = TABLE_TWO_DESC_GEOM
  return [
    {
...
export function tableTwoDescOverlay(canvasW, canvasH) {
  const g = TABLE_TWO_DESC_GEOM
...
export function specToTableTwoDescContent(spec, palette) {
  return {
...
export function tableTwoDescPreviewSvg() {
 ...
 */
export function layoutTableTwoDesc(elements, schema, palette = {}, canvas = {}) {
