...
export const BULLET_LIST_NUMBERED_VERTICAL_GEOM = {
  viewW: 1000,
  viewH: 560,
  headingX: 48,
  headingY: 18,
...
export const BULLET_LIST_NUMBERED_VERTICAL_ROWS = [
...
export const BULLET_LIST_NUMBERED_VERTICAL_DEFAULTS = {
  HEADING: '6-Step Curved Block List',
  TITLE: 'Lorem Ipsum',
  ITEM: 'Lorem ipsum dolor sit amet, nibh est. A magna maecenas, quam magna nec quis.',
}

export function isBulletListNumberedVerticalLayout(layoutId) {
...
export function buildVerticalBlockRowSvg({
  width,
  height,
  tabW,
  slant,
...
export function layoutBulletListNumberedVertical(docOrElements, schema, palette = {}, canvas = {}) {
...
export function bulletListNumberedVerticalPreviewSvg() {
  const g = BULLET_LIST_NUMBERED_VERTICAL_GEOM
