...
export const AGENDA_SPLIT_PANEL_GEOM = {
  viewW: 1000,
  viewH: 560,
  headingX: 400,
  headingY: 14,
...
export const SPLIT_PANEL_ACCENT = '#2E89E6'
...
export const SPLIT_PANEL_IMAGE_CLIP = sampleClipPercents()
...
export function agendaSplitPanelImageClip() {
...
export function agendaSplitPanelChromeSpecs() {
  return [{
...
export function agendaSplitPanelOverlayPlacements(gx, gy, gw, gh) {
