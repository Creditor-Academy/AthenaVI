...
export function isImageParaCtaLayout(layoutId, schema) {
...
export const IMAGE_PARA_CTA_DEFAULTS = {
...
export function buildImageParaCtaChromeSvg() {
...
export function buildImageParaCtaPillSvg() {
...
export function layoutImageParaCta(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildImageParaCtaCanvasElements({ schema, options = {} } = {}) {
...
export function imageParaCtaPreviewSvg() {
