...
export function isTeamThreeFullCardsLayout(layoutId) {
  return /team_three_full_cards_v1/i.test(String(layoutId || ''))
}

export function teamThreeFullCardsGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutTeamThreeFullCards(elements, schema, palette = {}, canvas = {}) {
