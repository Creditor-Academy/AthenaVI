...
export function isComparisonSideBySideCenterlineLayout(layoutId, schema) {
...
export const COMPARISON_SIDE_BY_SIDE_CENTERLINE_DEFAULTS = {
...
export function buildComparisonSideBySideCenterlineChromeSvg() {
...
export function layoutComparisonSideBySideCenterline(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildComparisonSideBySideCenterlineCanvasElements({ schema, options = {} } = {}) {
...
export function comparisonSideBySideCenterlinePreviewSvg() {
