...
export function isClosingThankYouLayout(layoutId, schema) {
...
export const CLOSING_THANK_YOU_DEFAULTS = {
  HEADING: 'Thank you',
  SUBTITLE: 'Questions?',
}
...
export function buildClosingThankYouChromeSvg() {
  const { markY } = GEOM
...
export function layoutClosingThankYou(docOrElements, schema = {}, palette = {}, canvas = {}) {
...
export function buildClosingThankYouCanvasElements({ schema, options = {} } = {}) {
...
export function closingThankYouPreviewSvg() {
