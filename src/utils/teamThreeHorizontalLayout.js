/** Team three: heading unchanged; hex portraits on cards with name + description. */

export const TEAM_HEX_CLIP =
  'polygon(50% 0%, 93% 25%, 93% 75%, 50% 100%, 7% 75%, 7% 25%)'

const TEAM_DECO = /^TEAM_(CARD_BG|HEX_RING)_/i

export function isTeamThreeHorizontalLayout(layoutId) {
  return /team_three_horizontal/i.test(String(layoutId || ''))
}

export function teamThreeHorizontalGeom(canvasW = 1920, canvasH = 1080) {
...
export function layoutTeamThreeHorizontal(elements, schema, palette = {}, canvas = {}) {
