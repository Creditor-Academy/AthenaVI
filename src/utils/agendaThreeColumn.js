...
export const AGENDA_THREE_COLUMN_GEOM = {
  viewW: 1000,
  viewH: 560,
  headingY: 8,
  headingH: 42,
...
export const DEFAULT_COLUMN_PALETTE = [
...
export function agendaThreeColumnGraphicFrame(canvasW, canvasH) {
...
export function agendaThreeColumnCardInlineSvg(spec) {
  const w = spec.w
  const h = spec.h
...
export function agendaThreeColumnRuleInlineSvg() {
...
export function agendaThreeColumnIconInlineSvg(iconKey = 'document') {
  const cx = 28
  const cy = 28
...
export function agendaThreeColumnNumberInlineSvg(label = '01') {
...
export function colouredColumnTextContent(content = {}, opts = {}) {
  const {
    color = '#111827',
    fontSize = 16,
    fontWeight = 400,
...
export function agendaThreeColumnChromeSpecs(colors = {}) {
...
export function agendaThreeColumnOverlayPlacements(gx, gy, gw, gh) {
...
export function agendaThreeColumnPreviewSvg(colors = {}) {
...
export function specToThreeColumnContent(spec) {
  if (spec.cardChrome) {
...
export function isAgendaThreeColumnsDefaultLayout(layoutId, schema) {
...
export function isAgendaThreeColumnTextSlot(slotId) {
