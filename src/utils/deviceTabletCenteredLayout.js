/** Centered landscape tablet under a title — screen fills the bezel, device stays on-canvas. */

export function isDeviceTabletCenteredLayout(layoutId) {
...
export function layoutDeviceTabletCentered(elements, schema, palette = {}, canvas = {}) {
