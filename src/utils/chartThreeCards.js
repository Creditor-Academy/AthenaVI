...
export const CTC3_COLORS = {
  card1: '#3B82F6',  // Blue
  card2: '#8B5CF6',  // Purple
  card3: '#10B981',  // Green
}

export const CTC3_DEFAULTS = {
...
export function chartThreeCardsChromeSpecs() {
  const g = CTC3_GEOM
  const card1X = 15
  ...
  return [
    ...
    {
      slotId: 'CTC3_CARD_1_ICON_CIRCLE',
      x: card1X + g.iconX,
      y: g.cardStartY + g.iconY,
      w: g.iconSize,
      h: g.iconSize,
      color: CTC3_COLORS.card1,
      layer: 4,
      kind: 'iconCircle',
    },
    {
      slotId: 'CTC3_CARD_1_ICON',
      x: card1X + g.iconX,
      y: g.cardStartY + g.iconY,
      w: g.iconSize,
      h: g.iconSize,
    ...
    {
      slotId: 'CTC3_CARD_1_INSIGHT_ICON_CIRCLE',
    ...
    {
      slotId: 'CTC3_CARD_1_INSIGHT_ICON',
      x: card1X + g.insightX + 8,
      y: g.cardStartY + g.insightY + 10,
      w: g.insightIconSize,
      h: g.insightIconSize,
    ...
    {
      slotId: 'CTC3_CARD_2_ICON_CIRCLE',
      x: card2X + g.iconX,
      y: g.cardStartY + g.iconY,
      w: g.iconSize,
      h: g.iconSize,
      color: CTC3_COLORS.card2,
      layer: 4,
      kind: 'iconCircle',
    },
    {
      slotId: 'CTC3_CARD_2_ICON',
      x: card2X + g.iconX,
      y: g.cardStartY + g.iconY,
      w: g.iconSize,
      h: g.iconSize,
    ...
    {
      slotId: 'CTC3_CARD_2_INSIGHT_ICON_CIRCLE',
    ...
    {
      slotId: 'CTC3_CARD_2_INSIGHT_ICON',
      x: card2X + g.insightX + 8,
      y: g.cardStartY + g.insightY + 10,
      w: g.insightIconSize,
      h: g.insightIconSize,
    ...
    {
      slotId: 'CTC3_CARD_3_ICON_CIRCLE',
      x: card3X + g.iconX,
      y: g.cardStartY + g.iconY,
      w: g.iconSize,
      h: g.iconSize,
      color: CTC3_COLORS.card3,
      layer: 4,
      kind: 'iconCircle',
    },
    {
      slotId: 'CTC3_CARD_3_ICON',
      x: card3X + g.iconX,
      y: g.cardStartY + g.iconY,
      w: g.iconSize,
      h: g.iconSize,
    ...
    {
      slotId: 'CTC3_CARD_3_INSIGHT_ICON_CIRCLE',
    ...
    {
      slotId: 'CTC3_CARD_3_INSIGHT_ICON',
      x: card3X + g.insightX + 8,
      y: g.cardStartY + g.insightY + 10,
      w: g.insightIconSize,
      h: g.insightIconSize,
...
export function chartThreeCardsOverlay(gx, gy, gw, gh) {
  const g = CTC3_GEOM
  const sx = gw / g.viewW
  const sy = gh / g.viewH
  const box = (x, y, w, h) => ({
...
export function specToChartThreeCardsContent(spec) {
...
export function layoutChartThreeCards(elements, schema, palette = {}, canvas = {}) {
  ...
  const filtered = elements.filter((el) => !chromeRe.test(String(el.slotId || '')) && isChartThreeCardsTextSlot(el.slotId))
  ...
  const chrome = chartThreeCardsChromeSpecs().map((spec) => {
    const prev = prevBySlot.get(spec.slotId.toUpperCase())
    const graphic = specToChartThreeCardsContent(spec)
    if (!graphic) return null
    return {
      id: prev?.id || newId('shp-ctc3'),
      type: 'graphic',
      layer: spec.layer || 4,
      placement: {
...
export { isChartThreeCardsLayout, isChartThreeCardsTextSlot }
