...
import { MdMoreVert, MdEdit, MdPersonAdd, MdSort, MdViewModule, MdDelete, MdSettings, MdFolder } from 'react-icons/md';

const ContextMenu = ({ type, onRename, onAddMembers, onSort, onView, onDelete, onManageWorkspace, onMove }) => {
