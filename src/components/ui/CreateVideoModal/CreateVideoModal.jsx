...
const CreateVideoModal = ({
  ...
  const handleCreate = async () => {
    ...
    const payload = {
      ...
      templateId: selectedTemplateId === 'blank' ? null : selectedTemplate?.id || null,
      workspaceId,
      folderId
    };
    ...
    setSubmitting(true);
    try {
      const createdVideo = await workspaceService.createVideo(workspaceId, payload);

      const eventVideo = {
        ...createdVideo,
        id: createdVideo.id || createdVideo._id,
        name: createdVideo.name || createdVideo.title || payload.title
      };
